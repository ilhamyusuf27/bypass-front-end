...
const ProfileEmployee = () => {
  ...
  const getSosmedEmployee = () => {
    axios
      .get(
        `${process.env.REACT_APP_URL_API}/sosmed/findByIdUser?id_user=${idEmployee.id}`
      )
      .then((res) => {
                      ...
                      <div className="card-body">
                        ...
                        >
                          <Tab eventKey="portofolio" title="Portofolio">
                            {portofolioEmployee?.length > 0 ? (
                              <PortofolioEmployee data={portofolioEmployee} />
                            ) : (
                              <NoDataComp title="Belum ada Portofolio" />
                            )}
                          </Tab>
                          <Tab
                          ...
                          >
                            {experience?.length > 0 ? (
                              <ExperienceEmployee data={experience} />
                            ) : (
                              <NoDataComp title="Belum ada Experience" />
                            )}
                          </Tab>
                        </Tabs>
                      </div>
