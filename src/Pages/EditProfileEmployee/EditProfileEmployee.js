...
const EditProfileEmployee = () => {
	...
	const handleSaveProfile = (e) => {
		...
		if (detailEmployee?.id_user === null) {
			...
			axios
				.patch(`${process.env.REACT_APP_URL_API}/user/editPhoto`, formData, config)
				.then((respons) => {
					console.log(respons);
				})
				.catch((errors) => {
			...
			axios
				.patch(`${process.env.REACT_APP_URL_API}/detailUser/update`, body, config)
				.then((res) => {
					Swal.fire({
						icon: "success",
						text: "Profile Berhasil di edit",
							...
							<div className="row mt-5">
								<div className="col-4">
									...
									<div className="row button-edit-employee">
										<Button variant="flat" size="lg" className="mb-3" onClick={handleSaveProfile}>
											Simpan
										</Button>
										<Link to={`/profile-employee/${idEmployee.id}`} className="p-0" style={{ textDecoration: "none" }}>
											...
											<form>
												...
												<div className="mb-3">
													...
													<input
														type="text"
														className="form-control form-control-lg"
														placeholder={`${detailEmployee?.tempat_kerja ? detailEmployee?.tempat_kerja : ""}`}
												...
												<div className="mb-3">
													<div className="row">
														<div className="col-10">
															<input type="text" className="form-control form-control-lg" placeholder="Example: Java" onChange={(e) => setAddSkill(e.target.value)} />
															<div className="mt-2">
														...
														<div className="col-2">
															{isLoading ? (
																...
																<Button variant="warning-flat" size="lg" onClick={handleAddSkills}>
																	Simpan
																</Button>
															)}
														</div>
										...
										<div className="card-body">
											...
											<form>
												...
												{isLoading ? (
													...
													<Button variant="warning-flat" style={{ width: "100%" }} size="lg" className="mb-3" onClick={handleAddExperience}>
														Simpan Pengalaman kerja
													</Button>
												)}
											</form>
											<hr />
											<Button variant="outline-warning-flat" style={{ width: "100%" }} size="lg" className="mb-3" onClick={handleShow}>
												Tambah Portofolio
											</Button>
