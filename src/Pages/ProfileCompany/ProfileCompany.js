          ...
          <div className="col-lg-12 col-sm-12">
            <div className="card hovercard mt-5">
              ...
              <div className="info">
                ...
                <div className="desc">Purwokerto, Jawa Tengah</div>
              </div>
              ...
              <Container>
                ...
                <div className="row pt-5 pb-5 social">
                  <Col md={{ span: 6, offset: 3 }}>
                    <table>
                      <tr>
                        <td> <h3><FaRegEnvelope /></h3> </td>
                        <td className="px-3">martabatjaya@gmail.com</td>
                      </tr>
                      <tr>
                        <td> <h3><FaInstagram /></h3> </td>
                        <td className="px-3">martabat_jaya</td>
                      </tr>
                      <tr>
                        <td> <h3><BsTelephone /></h3> </td>
                        <td className="px-3">0821-8190-1821</td>
                      </tr>
                      <tr>
                        <td> <h3><FiLinkedin /></h3> </td>
                        <td className="px-3">Martabat Jaya Abadi</td>
                      </tr>
                    </table>
                  </Col>
                </div>
