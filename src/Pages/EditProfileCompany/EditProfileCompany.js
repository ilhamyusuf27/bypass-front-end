...
import { Container, Row, Button, Card, Form, FloatingLabel } from "react-bootstrap";
				...
				<Row>
					<div className="col-lg-4 col-md-4 col-sm-12">
						...
						<div className="d-grid gap-2">
							<Button type="submit" size="lg" className="button-edit mb-2" onClick={handleSimpan} disabled={isLoading}>
							...
							<Card.Body>
								<Form onSubmit={(e) => e.preventDefault()}>
									<Form.Group className="mb-3">
										...
										<Form.Control type="text" value={name} placeholder="Masukkan nama perusahaan" onChange={(e) => setName(e.target.value)} />
									</Form.Group>

									<Form.Group className="mb-3">
										<Form.Label>Bidang</Form.Label>
										<Form.Control type="text" value={business_fields} placeholder="Masukkan bidang perusahaan ex: Financial" onChange={(e) => setBusinessField(e.target.value)} />
									</Form.Group>

									<Form.Group className="mb-3">
										<Form.Label>Kota</Form.Label>
										<Form.Control type="text" value={city} placeholder="Masukkan kota" onChange={(e) => setCity(e.target.value)} />
									</Form.Group>

									<Form.Group className="mb-3">
										<Form.Label>Deskripsi singkat</Form.Label>
										<FloatingLabel controlId="floatingTextarea2" label="Tuliskan deskripsi singkat">
											<Form.Control as="textarea" value={description} placeholder="Tuliskan deskripsi singkat" onChange={(e) => setDescription(e.target.value)} style={{ height: "100px" }} />
										</FloatingLabel>
									</Form.Group>

									<Form.Group className="mb-3">
										<Form.Label>E-mail</Form.Label>
										<Form.Control type="email" value={email} placeholder="Masukkan email" onChange={(e) => setEmail(e.target.value)} />
									</Form.Group>

									<Form.Group className="mb-3">
										<Form.Label>Instagram</Form.Label>
										<Form.Control type="text" value={instagram} placeholder="Masukkan nama instagram" onChange={(e) => setInstagram(e.target.value)} />
									</Form.Group>

									<Form.Group className="mb-3">
										<Form.Label>Nomor Telepon</Form.Label>
										<Form.Control type="text" value={phone} placeholder="Masukkan nomor telepon" onChange={(e) => setPhone(e.target.value)} />
									</Form.Group>

									<Form.Group className="mb-5">
										<Form.Label>Linkedin</Form.Label>
										<Form.Control type="text" value={linkedin} placeholder="Masukkan nama Linkedin" onChange={(e) => setLinkedin(e.target.value)} />
									</Form.Group>
								</Form>
							</Card.Body>
						</Card>
